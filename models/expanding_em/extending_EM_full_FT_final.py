...
if __name__ == "__main__":
    ...
    start_training(
        ...
        test_file=TEST_FILE,
        output_dir=OUTPUT_DIR,
        source_lang=SOURCE_CODE,    # fake code for Warao, this was suggested by the Few Thousand Translations paper
        target_lang=TARGET_CODE,    # Spanish code
